...
public interface JavaGrep {
  ...
  /**
   * Executes the grep program line by line and returns the result to a file. All information should
   * be provided as an argument or a user prompt.
   *
  ...
  /**
   * List all files given a root directory. It does not list files inside nested directory.
   *
  ...
  /**
   * Verify that the line has a matching pattern. Ensure that the implementation has a regex pattern
   * to match the given line.
   *
