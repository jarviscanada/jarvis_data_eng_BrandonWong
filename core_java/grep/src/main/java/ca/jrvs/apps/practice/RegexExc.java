...
public interface RegexExc {
  /**
   * Match given filename with a jpeg format. Ensure that filename ends with `.jpg` and `.jpeg`
   *
   * @param filename
  ...
  /**
   * Match given ip with a ip format. Ensure that the ip is between 0.0.0.0 to 999.999.999.999
   *
   * @param ip
